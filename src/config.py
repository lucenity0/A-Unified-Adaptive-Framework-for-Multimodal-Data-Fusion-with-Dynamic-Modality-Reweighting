...
ENV_MAP = {
    ...
    "CLIP_LR":                ("clip_lr",                float),
    "FUSION_LR":              ("fusion_lr",              float),
    "MIXUP_ALPHA":            ("mixup_alpha",            float),
    "RDROP_WEIGHT":           ("rdrop_weight",           float),
    "AUX_WEIGHT":             ("aux_weight",             float),
    "ENTROPY_WEIGHT":         ("entropy_weight",         float),
    "DIVERSITY_WEIGHT":       ("diversity_weight",       float),
    "SUPCON_WEIGHT":          ("supcon_weight",          float),
